package aboutZookeeper.zookeeperWatcher;
...
public class ZooKeeperWatcher implements Watcher{
     ...
     * @param data 数据内容
     * @return
     * @description: //修改节点的值，-1表示跳过版本检查，其他正数表示如果传入的版本号与当前版本号不一致，则修改不成功，删除是同样的道理。
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        //创建连接
        zkWatch.createConnection(CONNECTION_ADDR, SESSION_TIMEOUT);//1
