...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/lib/bootstrap-3.3.5/css/bootstrap.min.css"
          type="text/css"/>
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/lib/bootstrap-3.3.5/css/bootstrap-responsive.css"
          type="text/css"/>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/lib/jquery.mCustomScrollbar.min.css"
          type="text/css"/>
...
<div class="middleContent" style="height:100%;">
    <div class="searchBar">
        <div>
            <div>
                <input type="text" class="form-control" name="searchApprovalMessage" id="searchApprovalMessage"
                       placeholder="请按文件名检索" style="width:250px;"/>
