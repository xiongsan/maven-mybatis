...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        readFiles: function (files) {
            ...
            function readFile(i) {
                ...
                if (self.maxFileSize > 0 && parseInt(fileSize) > parseInt(self.maxFileSize)) {
    ...
    $.fn.fileinput.locales.en = {
        ...
        */
        ...
        uploadLabel: '上传',
        uploadTitle: '上传选中文件',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>)的大小超过了允许上传的最大值<b>{maxSize} KB</b>,请重新输入!',
       // msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>. Please retry your upload!',
